...
describe('calculateNumber', () => {
    describe('type == "SUM"', () => {
        ...
        it('negative and positive numbers', () => {
            expect(calculateNumber('SUM', -3.0, 2.0)).to.equal(-1);
        });
    ...
    describe('type == "SUBTRACT"', () => {
        ...
        it('equal positive numbers (alternate)', () => {
            expect(calculateNumber('SUBTRACT', 3.3, 1.8)).to.equal(1);
        });
    ...
    describe('type == "DIVIDE"', () => {
        it('positive numbers', () => {
            expect(calculateNumber('DIVIDE', 8.0, 3.0)).to.equal(2.6666666666666665);
        });

        it('numbers with different signs', () => {
            expect(calculateNumber('DIVIDE', -7.0, 3.0)).to.equal(-2.3333333333333335);
        });
